          ...
          <div className="flex h-full">
            <div className="self-end mb-8 ml-8">
              <div className="text-white p-6 rounded-xl bg-black/10 backdrop-blur-md inline-block">
                <h1 className="text-8xl font-light mb-3">{data.current.temperature}°C</h1>
                <h2 className="text-4xl font-medium mb-2">{data.current.location}</h2>
                <p className="text-lg opacity-80">
                  {data.current.time} | H:{data.current.high}° L:{data.current.low}°
                </p>
              </div>
            </div>
